...
#define swap64(x) \
	((unsigned long long)(\
	 (((unsigned long long)(x)&(unsigned long long)0x00000000000000ffUL)<<56)|\
	 (((unsigned long long)(x)&(unsigned long long)0x000000000000ff00UL)<<40)|\
	 (((unsigned long long)(x)&(unsigned long long)0x0000000000ff0000UL)<<24)|\
	 (((unsigned long long)(x)&(unsigned long long)0x00000000ff000000UL)<<8)|\
	 (((unsigned long long)(x)&(unsigned long long)0x000000ff00000000UL)>>8)|\
	 (((unsigned long long)(x)&(unsigned long long)0x0000ff0000000000UL)>>24)|\
	 (((unsigned long long)(x)&(unsigned long long)0x00ff000000000000UL)>>40)|\
	 (((unsigned long long)(x)&(unsigned long long)0xff00000000000000UL)>>56)));
#endif
