#ifndef __MDAS_BUTYE_BUFFER_H_H_
#define __MDAS_BUTYE_BUFFER_H_H_
...
static inline void bytebuffer_writelength(unsigned char *s, unsigned char len){
	unsigned char * buf = s+1;
	bytebuffer_writeword(&buf, len);
}
